...
public class ApiClient {
    ...
    public void setBasicAuth()
    {
        ...
        authentications.put("Basic", basicAuth);
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://proghackuc2017.osisoft.com/piwebapi
    ...
    private void applySslSettings() {
        try {
            ...
            if (keyManagers != null || trustManagers != null) {
                ...
                //clientBuilder.sslSocketFactory(null,null);
            }
